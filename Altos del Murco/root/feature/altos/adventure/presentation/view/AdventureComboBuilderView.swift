        ...
        Section {
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack(alignment: .top, spacing: 12) {
                    ...
                    Text("Si reservas solo comida, estos horarios se usan como hora preferida de llegada. Si agregas actividades, representan el inicio de la experiencia.")
                        .font(.footnote)
    ...
    private var foodSection: some View {
        Section {
            ...
            .sheet(isPresented: $isFoodPickerPresented) {
                AdventureComboBuilderFoodPickerBridge(
